    ...
    showConfirmDialog({
      ...
      onConfirm: async () => {
        try {
          ...
          message.error(error.message || 'Failed to deactivate supplier');
        }
      }
    });
  };
            ...
            {loading ? (
              ...
              suppliers.map((supplier) => (
                <tr key={supplier._id}>
                  ...
                  <td>₹{supplier.openingBalance?.toFixed(2) || '0.00'}</td>
                  <td>
                    <span style={{
                      ...
                      fontSize: '12px',
                      fontWeight: '500',
                      background: `${getStatusColor(supplier.active)}20`,
                      color: getStatusColor(supplier.active),
                      border: `1px solid ${getStatusColor(supplier.active)}`
                    }}>
