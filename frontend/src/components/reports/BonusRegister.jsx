...
const BonusRegister = () => {
  ...
  const [rateMode, setRateMode] = useState('Rate'); // 'Rate' | 'Percentage'
  ...
  const handlePost = async () => {
    ...
    setPosting(true);
    try {
      const res = await bonusRegisterAPI.postToDaybook(registerId, { paymentMode, bankLedgerId: paymentMode === 'Bank' ? bankLedgerId : undefined });
      setPosted(true);
        ...
        <Stack gap="md">
          ...
          <Grid gutter="md" align="flex-end">
            <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
              ...
              <SegmentedControl fullWidth data={[{ value: 'Rate', label: 'Rate/Ltr' }, { value: 'Percentage', label: 'Percentage' }]} value={rateMode} onChange={setRateMode} />
            </Grid.Col>
            {rateMode === 'Rate' ? (
              <>
                <Grid.Col span={{ base: 12, sm: 6, md: 3 }}>
