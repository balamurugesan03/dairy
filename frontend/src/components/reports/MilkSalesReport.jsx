...
<title>Milk Sales Report – ${societyName}</title>
<style>
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
body{font-family:Arial,Helvetica,sans-serif;font-size:10px;background:#fff;-webkit-print-color-adjust:exact;print-color-adjust:exact;padding:8mm}
table{width:100%;border-collapse:collapse}
th,td{border:1px solid #ccc;padding:3px 6px;vertical-align:middle}
th{background:#1c3d6e!important;color:#fff!important;font-weight:700;text-align:center;font-size:9px}
.tot{background:#1c3d6e!important;color:#fff!important;font-weight:800}
      ...
      <Paper radius="md" withBorder style={{ overflow: 'hidden' }}>
        ...
        <div style={{ display: 'none' }} className="print-header">
          <div style={{ textAlign: 'center', marginBottom: 12 }}>
            <div style={{ fontSize: 16, fontWeight: 900, textTransform: 'uppercase', letterSpacing: 2 }}>{societyName}</div>
            <div style={{ fontSize: 11, fontWeight: 700, marginTop: 4 }}>MILK SALES REPORT — {modeConf.label.toUpperCase()}</div>
            <div style={{ fontSize: 9, color: '#555', marginTop: 3 }}>Period: {periodLabel} | Printed: {fmtDate(localDateStr(new Date()))}</div>
          </div>
        </div>
