...
import './VyaparPurchaseReport.css';
...
const VyaparPurchaseReport = () => {
  ...
  return (
    <div className="vyapar-purchase-report">
      <PageHeader
        title="Purchase Report"
        subtitle="Detailed purchase transaction report with payment status"
      />

      <DateFilterToolbar onFilterChange={handleFilterChange} />

      {loading && (
        <div className="loading-message">Loading purchase report...</div>
      )}
        ...
        <>
          ...
          <div className="summary-cards">
            <div className="summary-card danger">
              ...
              <div className="card-value">{formatCurrency(reportData.summary.totalPurchases)}</div>
          ...
          <div className="report-table-container">
            <div className="table-header">
              ...
              <ExportButton data={exportData} filename="purchase_report" />
            </div>
