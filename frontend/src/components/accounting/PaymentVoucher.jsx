  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Create payment voucher for money paid"
      />
      ...
      <div className="form-card">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="form-help">Select the party or expense account to which payment is made</div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="form-help">Select the cash or bank account from which payment is made</div>
          </div>
