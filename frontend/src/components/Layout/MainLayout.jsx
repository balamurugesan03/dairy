...
const MainLayout = () => {
  ...
  useEffect(() => {
    const handleKey = (e) => {
      ...
      if (e.key === 'F5') { e.preventDefault(); navigate('/payments/cash-advance/voucher'); return; }
  ...
  const getFilteredMenuItems = () => {
    ...
    ...(selectedBusinessType === 'Dairy Cooperative Society' ? [{
      ...
      children: [
        ...
        { key: '/daily-collections/incentive-register', label: 'Incentives' },
        { key: '/daily-collections/bonus-register',     label: 'Bonus' },
