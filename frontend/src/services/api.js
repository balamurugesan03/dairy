...
export const paymentAPI = {
  ...
  getFarmerPreviousBalance: (farmerId, params) => api.get(`/farmer-payments/farmer/${farmerId}/previous-balance`, { params }).then(res => res.data).catch(handleError),
};
...
export const paymentRegisterAPI = {
  ...
  getLockedCycles:      ()            => api.get('/payment-register/locked-cycles').then(r => r.data).catch(handleError),
